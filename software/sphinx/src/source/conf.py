...
project = 'DevLab Development Board User Guide and Technical Reference'
...
html_theme_options = {
    "repository_url": "https://github.com/UNIT-Electronics-MX/unit_devlab_py32f003l24d6tr_development_board",  # URL of your project's repository
...
latex_documents = [
    ('index', 'programmer.tex', 'DevLab Development Board User Guide and Technical Reference',
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{DevLab Development Board}
